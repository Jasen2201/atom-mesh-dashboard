...
data/                  # generated by update_data.py
├── index.json         # manifest of runs
└── <run_id>.json      # one file per SLURM run (sweep points + gsm8k)
update_data.py         # scan /it-share/yajizhan/slurm_logs/ → rebuild data/
